...
<div class="content-wrapper-scroll">
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        {!! Form::open(array('route' =>['countryAggriments.update', $countryAggriment->id],'method'=>'PUT','files'=>true)) !!}
        <div class="card">
          <div class="card-header">
            <div class="card-title">Update Country Agreement</div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    ...
                    @forelse ($countries as $country)
                        <option value="{{$country->id}}" {{($country->id == $countryAggriment->country_id) ? 'selected' : ''}}>{{$country->name}}</option>
                    @empty
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    ...
                    value="{{$countryAggriment->title ?? old('title')}}"
                    autocomplete="off">
                  </div>
