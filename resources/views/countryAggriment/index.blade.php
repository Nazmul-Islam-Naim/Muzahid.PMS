      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title">Country Agreements</h3>
              <a href="{{route('countryAggriments.create')}}" class="btn btn-sm btn-primary"><i class="icon-plus-circle"></i> Add New</a>
            </div>
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
   ...
   // ==================== date format ===========
	$(document).ready(function() {
      ...
      var table = $('#example').DataTable({
			...
			processing: true,
      deferRender : true,
			ajax: "{{route('countryAggriments.index')}}",
		...
		columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return '<a href="'+ url +'" target="_blank"><i class="icon-documents"></i></a>'
                }
            },
            {data: 'action'},
        ]
    ...
    $("#example").on("click", ".button-delete", function(e) {
			...
			var id = $(this).data('id');
			var url = '{{route("countryAggriments.destroy",":id")}}';
