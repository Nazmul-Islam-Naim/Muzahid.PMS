    ...
    <div class="row gutters" >
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="collapse" id="Award">
            <div class="card card-body" style="background-color:{{$color4??'#16a396'}}; color:white;">
              <div class="table-responsive">
                <table class="table table-bordered" style="background-color:{{$color4??'#16a396'}}; color:white;">
                    <tbody>
                      <tr>
