...
<header>
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="">
                <a href="#"><img src="{{ asset('custom/website/img/header_pppo.jpg') }}" width="100%"
                        alt="PPPA"></a>
            </div>
        </div>
    </div>
                    ...
                    <nav>
                        <ul id="nav">
                            <li class="current"><a style="line-height:30px; color:white; text-decoration:none"
                                    href="{{ route('web-project-list') }}">Projects</a></li>
                            <li class="current"><a style="line-height:30px; color:white; text-decoration:none"
                                    href="{{ route('sectors') }}">Sector</a></li>
                            <li class="current"><a style="line-height:30px; color:white; text-decoration:none"
                                    href="{{ route('ministries') }}">Ministry</a></li>
                            <li><a style="line-height:30px; color:white; text-decoration:none" href="#">Phases<i
                                        class="fa fa-angle-down"></i></a>
                                <ul class="sub-menu">
                                    <li class="current"><a style="text-decoration:none"
                                            href="{{ route('phase', 'identification-phase') }}">Identitification
                                            Phase</a></li>
                                    <li class="current"><a style="text-decoration:none"
                                            href="{{ route('phase', 'development-phase') }}">Development Phase</a></li>
                                    <li class="current"><a style="text-decoration:none"
                                            href="{{ route('phase', 'procurement-phase') }}">Procurement Phase</a></li>
                                    <li class="current"><a style="text-decoration:none"
                                    ...
                                    <li class="current submenu">
                                        ...
                                        <ul class="subsubmenu">
                                            <li class="current"><a style="text-decoration:none"
                                                    href="{{ route('cp-obligations') }}">CP</a></li>
                                            <br />
                                            <li class="current"><a style="text-decoration:none"
                            ...
                            <li class="current"><a style="line-height:30px; color:white; text-decoration:none"
                                    href="{{ route('glossary') }}">PPP Glossary</a></li>
                            <li class="current"><a style="line-height:30px; color:white; text-decoration:none"
                        ...
                        <nav id="dropdown">
                            <ul>
                                ...
                                <li class="current"><a
                                        style="line-height:30px; background:#eee; color:#186B59; text-decoration:none"
                                        href="{{ route('ministries') }}">Ministry</a></li>
                                <li><a style="line-height:30px; background:#eee; color:#186B59; text-decoration:none"
                                        href="#">Phases<i class="fa fa-angle-down"></i></a>
                                    <ul class="sub-menu">
                                        <li class="current"><a
                                                style="text-decoration:none ; background:#eee; color:#186B59;"
                                                href="{{ route('phase', 'identification-phase') }}">Identitification
                                                Phase</a></li>
                                        <li class="current"><a
                                                style="text-decoration:none ; background:#eee; color:#186B59;"
                                                href="{{ route('phase', 'development-phase') }}">Development Phase</a>
                                        </li>
                                        <li class="current"><a
                                                style="text-decoration:none ; background:#eee; color:#186B59;"
                                                href="{{ route('phase', 'procurement-phase') }}">Procurement Phase</a>
                                        </li>
                                        <li class="current"><a
                                                style="text-decoration:none ; background:#eee; color:#186B59;"
                                                href="{{ route('phase', 'award-phase') }}">Award Phase</a></li>
