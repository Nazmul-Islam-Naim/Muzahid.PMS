...
<div>
    <div class="container mt-5">
        <h5>PPP Contracting Authority Wise Project List</h5>
    <hr>
    </div>
</div>
<div class="container">
...
<script>
	$(document).ready(function() {
		'use strict';
    var slug = $('#slug').val();
    var authorityRoute = '{{route("contracting-project-list",":id")}}'; 
    var authorityRoute = authorityRoute.replace(':id', slug);
